#!/usr/bin/env python3
"""Show VIM4 CPU, memory, and time on a 128x64 SSD1306 I2C OLED.
...
Examples:
  sudo python3 vim4_oled_sys_monitor.py
  sudo python3 vim4_oled_sys_monitor.py --bus 5 --addr 0x3c --interval 1
"""
...
def main() -> int:
    ...
    parser.add_argument("--bus", type=parse_int, default=5, help="I2C bus number, default: 5")
