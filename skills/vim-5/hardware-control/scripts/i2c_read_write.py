#!/usr/bin/env python3
"""Minimal VIM 5 I2C helper using Linux /dev/i2c-*.

Examples:
  sudo python3 i2c_read_write.py read --bus 3 --addr 0x40 --reg 0x00
  sudo python3 i2c_read_write.py write --bus 3 --addr 0x40 --reg 0x01 --value 0xff
  sudo python3 i2c_read_write.py write-bytes --bus 3 --addr 0x3c --data 0x00 0xae
  sudo python3 i2c_read_write.py read-raw --bus 3 --addr 0x40 --length 4
"""
