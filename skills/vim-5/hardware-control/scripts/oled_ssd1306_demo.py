#!/usr/bin/env python3
"""Minimal SSD1306 I2C OLED demo for Khadas VIM 5.

Examples:
  sudo python3 oled_ssd1306_demo.py --bus 3 --addr 0x3c
  sudo python3 oled_ssd1306_demo.py --bus 3 --addr 0x3c --fill
"""
...
class SSD1306:
    ...
    def draw_demo(self) -> None:
        self.clear()
        self.draw_page_text(0, 0, "VIM 5 OLED")
        self.draw_page_text(2, 0, "I2C-3 0X3C")
...
def main() -> int:
    ...
    parser.add_argument("--bus", type=parse_int, default=3)
